  ...
  tablesConfig: [
    {
      ...
      tableCol: [
        {
          prop: 'attrName', label: '属性名', minWidth: '100'
        },
        {
          prop: 'info', label: '介绍', minWidth: '100'
        },
        {
          prop: 'attrType', label: '类型', minWidth: '100'
        },
        {
    ...
    },
    {
      ...
      tableCol: [
        {
          prop: 'methodName', label: '方法名', minWidth: '100'
        },
        {
    ...
    },
    {
      ...
      tableCol: [
        {
          prop: 'slotName', label: '插槽名', minWidth: '100'
        },
        {
          prop: 'info', label: '插槽介绍', minWidth: '100'
        },
        {
          prop: 'argumentsInfo', label: '参数介绍', minWidth: '100'
        }
      ],
      tableConfig: {
        showFooter: false
